...
const AmazonDashboard = () => {
  ...
  const amazonShows = [
    { id: '1', title: 'The Boys', type: 'TV Show', genre: 'Action', year: 2019, rating: '18+', imdbScore: 8.7 },
    { id: '2', title: 'The Marvelous Mrs. Maisel', type: 'TV Show', genre: 'Comedy', year: 2017, rating: 'TV-14', imdbScore: 8.7 },
    { id: '3', title: 'Jack Ryan', type: 'TV Show', genre: 'Action', year: 2018, rating: 'TV-14', imdbScore: 8.0 },
    { id: '4', title: 'The Grand Tour', type: 'TV Show', genre: 'Documentary', year: 2016, rating: 'TV-PG', imdbScore: 8.7 },
    { id: '5', title: 'Borat Subsequent Moviefilm', type: 'Movie', genre: 'Comedy', year: 2020, rating: 'R', imdbScore: 6.6 },
    { id: '6', title: 'Sound of Metal', type: 'Movie', genre: 'Drama', year: 2019, rating: 'R', imdbScore: 7.7 },
    { id: '7', title: 'The Tomorrow War', type: 'Movie', genre: 'Action', year: 2021, rating: 'PG-13', imdbScore: 6.5 },
    { id: '8', title: 'Hunters', type: 'TV Show', genre: 'Drama', year: 2020, rating: 'TV-MA', imdbScore: 7.2 },
    { id: '9', title: 'Upload', type: 'TV Show', genre: 'Comedy', year: 2020, rating: 'TV-14', imdbScore: 8.0 },
    { id: '10', title: 'The Wheel of Time', type: 'TV Show', genre: 'Fantasy', year: 2021, rating: 'TV-14', imdbScore: 7.1 }
  ];
  ...
  const genreData = Object.entries(genreStats).map(([genre, count], index) => ({
    name: genre,
    value: count,
    color: ['#00A8E1', '#0073AA', '#005577', '#4A90A4', '#87CEEB', '#B0E0E6', '#E0F6FF'][index % 7]
  }));

  // Duration data
  const durationData = [
    { name: '1 min', value: 234, color: '#00A8E1' },
    { name: '1 Season', value: 1456, color: '#0073AA' },
    { name: '10 min', value: 876, color: '#005577' },
    { name: '10 Seasons', value: 543, color: '#4A90A4' },
    { name: '100 min', value: 321, color: '#87CEEB' },
    { name: '101 min', value: 187, color: '#B0E0E6' }
  ];
            ...
            <div style={{ transform: `scale(${genreZoom})`, transformOrigin: 'center' }}>
              <ResponsiveContainer width="100%" height={300}>
                <BarChart data={genreData} layout="horizontal">
                  ...
                  />
                  <Bar dataKey="value" fill="#00A8E1" radius={[0, 2, 2, 0]} />
                </BarChart>
              </ResponsiveContainer>
            </div>
          </CardContent>
            ...
            <div style={{ transform: `scale(${yearlyZoom})`, transformOrigin: 'center' }}>
              <ResponsiveContainer width="100%" height={300}>
                <BarChart data={yearlyData}>
                  ...
                  />
                  <Bar dataKey="movies" fill="#3B82F6" radius={[2, 2, 0, 0]} />
                  <Bar dataKey="series" fill="#06B6D4" radius={[2, 2, 0, 0]} />
                </BarChart>
              </ResponsiveContainer>
            </div>
          </CardContent>
          ...
          <div style={{ transform: `scale(${durationZoom})`, transformOrigin: 'center' }}>
            <ResponsiveContainer width="100%" height={300}>
              <BarChart data={durationData}>
                ...
                />
                <Bar dataKey="value" fill="#00A8E1" radius={[2, 2, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </CardContent>
